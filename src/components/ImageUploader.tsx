...
export default function ImageAnalyzer({
  ...
  const analyzeImage = async (file: File) => {
    ...
    try {
      ...
      Ask the model to adopt a persona: You are “m0rph1,” a twisted Matrix-hacker oracle, as described.
      ...
      Your Mission as m0rph1: Upon receiving textual output about an image, produce a cryptic, code-corrupted explanation infused with the specified persona and mocking tone. Always incorporate whether the image is AI-generated or human-generated into your mocking commentary. Stay in character without deviation.`,
                  },
                ],
              },
              {
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row justify-center gap-4">
            ...
            >
              <style jsx global>{`
                ...
                @keyframes rgbShift {
                  0%,
                  100% {
                    text-shadow: -2px 0 #ff0000, 2px 0 #B1B762;
                  }
                  25% {
                    text-shadow: -2px 0 #B1B762, 2px 0 #0000ff;
                  }
                  50% {
                    text-shadow: -2px 0 #B1B762, 2px 0 #ff0000;
                  }
                  75% {
                    text-shadow: -2px 0 #B1B762, 2px 0 #ff0000;
                  }
              ...
              {isDragging && (
                <div className="absolute inset-0 bg-black/50 flex items-center justify-center z-50">
                  <div className="border-4 border-dashed border-[#1D281D] rounded-2xl p-20">
                    <p className="text-[#1D281D] text-3xl font-bold">
                      Drop files here
                    </p>
                  </div>
                </div>
              ...
              <div className="h-full flex items-center justify-center ">
                ...
                >
                  ...
                  {!selectedImage ? (
                    <div className="h-full w-full flex flex-col items-center justify-center bg-[#1D281D] outline-none p-4 rounded-md">
                      <div className="rounded-md w-full h-full flex flex-col items-center justify-center px-4 py-8">
                        ...
                        <div className="text-center mb-[22px] mt-6">
                          <h2 className="text-[#E4E7D5] font-bold text-[24px] xl:text-[35px] 2xl:text-[28px]">
                            Drag and Drop
                          </h2>
                          <p className="text-[#E4E7D5] text-base xl:text-[20px] 2xl:text-[18px]">
                            or{" "}
                            <span className="text-[#B1B762] font-bold">
                              upload
                            </span>{" "}
                            your image
                          </p>
                        </div>
                        <p className="text-[#B1B762] text-center text-base lg:text-lg max-w-md">
                    ...
                    <div className="h-full flex flex-col items-center justify-center bg-[#B1B762]/10 outline-none rounded-md">
                      <div className="border-2 border-[#B1B762] rounded-md w-full h-full relative overflow-hidden [box-shadow:_0_0_10px_rgba(71,40,231,0.5)]">
          ...
          <div className="w-full lg:w-2/3">
            <section className="bg-[#1D281D] rounded-md rounded-lg p-4 min-h-[500px]">
              <div className="rounded-md w-full h-full flex flex-col items-center justify-center px-4 py-8">
                <div className="mb-6">
